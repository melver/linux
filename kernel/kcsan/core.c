...
static bool kcsan_weak_memory = IS_ENABLED(CONFIG_KCSAN_STRICT);
...
module_param_named(weak_memory, kcsan_weak_memory, bool, IS_ENABLED(CONFIG_KCSAN_STRICT) ? 0644 : 0444);
